                ...
                <div className="about-content-container">
                    ...
                    <div className="about-text-container">
                        ...
                        <div className="about-second-description">
                            ...
                            <div className="about-outside-text">I am an outgoing person  who loves socialising and spending time with friends. I enjoy being active and I spend a lot of time outside. I believe is great to connect with nature, enjoy the landscape and get away from the city every now and then.</div>
                        </div>   
